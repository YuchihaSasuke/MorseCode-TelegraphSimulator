...
def jiesao():
    ...
    if xuanze2=='1':
        ...
        print('【左键】 输入   【上滚】 退出   【右键】 清除   【鼠标移动到左上角】 暂停')
        print('如果打错了，可以使用  ******（即6个*） 来删除最近的一个错误')
    else:
        print('介绍：')
        print('【注意空格】例如： | ee == * *(一个空格) |\t| e e == *  *(两个空格) |')
        print('【左键】 输入   【上滚】 退出   【下滚】 保存   【右键】 清除   【鼠标移动到左上角】 暂停')
        print('如果打错了，可以使用  ******（即6个*） 来删除最近的一个错误')
        print('自由发报区')
        print('=' * 50)
        ...
        if pressed:
            ...
            if xuanze2 == '1' and time.perf_counter() - timea - bushijian > shijian:
                ...
                if xuanze2 == '1':
                    ...
                    if daojishi<60:
                        print('你有总共 {} 秒 !!!'.format(shijian))
                        print('还剩 {} 秒 !!!'.format(daojishi))
                    elif daojishi<3600:
                        print('你有总共 {}分 {}秒 !!!'.format(shijian // 60,shijian % 60))
                        print('还剩 {}分 {}秒 !!!'.format(daojishi // 60,daojishi % 60))
                    elif daojishi < 86400:
                        print('你有总共 {}时 {}分 {}秒 !!!'.format(shijian // 3600,(shijian % 3600) // 60,(shijian % 3600) % 60))
                        print('还剩 {}时 {}分 {}秒 !!!'.format(daojishi // 3600,(daojishi % 3600) // 60,(daojishi % 3600) % 60))
                    else:
                        print('你有总共 {}天 {}时 {}分 {}秒 !!!'.format(shijian // 86400, (shijian % 86400) // 3600, ((shijian % 86400) % 3600) // 60, (((shijian % 86400) % 3600) % 60)))
                        print('还剩 {}天 {}时 {}分 {}秒 !!!'.format(daojishi // 86400, (daojishi % 86400) // 3600, ((daojishi % 86400) % 3600) // 60, (((daojishi % 86400) % 3600) % 60)))
                    print('-'*15)
...
if __name__=="__main__":
    ...
    while 1:
        ...
        print('请使用英文输入法 !!!')
        print('本系列有以下几种玩法:\n')
        print('【1】摩根密码翻译器 【2】真·发电报 【3】摩根密码表 【回车键】退出程序')
        while 1:
            xuanze1=input('请选择:')
                    ...
                    if xuanze6 == '1':
                        ...
                        while 1:
                            ...
                            if dendaishichang<60:
                                zanshi = '\r||<=>' + '.' * (dendaishichang % 7) + '你等待了 ' + str(dendaishichang) + ' 秒 ' + ('.' * (dendaishichang % 7) + '<=>||')
                            elif dendaishichang<3600:
                                zanshi = '\r||<=>' + '.' * (dendaishichang % 7) + '你等待了 ' + '{}分 {}秒'.format(dendaishichang//60,dendaishichang%60) + ('.' * (dendaishichang % 7) + '<=>||')
                            elif dendaishichang<86400:
                                zanshi = '\r||<=>' + '.' * (dendaishichang % 7) + '你等待了 ' + '{}时 {}分 {}秒'.format(dendaishichang // 3600, (dendaishichang % 3600) // 60, (dendaishichang % 3600) % 60) + ('.' * (dendaishichang % 7) + '<=>||')
                            else:
                                zanshi = '\r||<=>' + '.' * (dendaishichang % 7) + '你等待了 ' + '{}天 {}时 {}分 {}秒'.format(dendaishichang//86400,(dendaishichang%86400)//3600,((dendaishichang%86400)%3600)//60,(((dendaishichang%86400)%3600)%60)) + ('.' * (dendaishichang % 7) + '<=>||')
                            print(zanshi, end='\r')
